  ...
  return (
    <footer className="w-full border-t border-outline-variant bg-surface-card py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-md text-sm leading-relaxed text-on-surface-variant">
              One Search. Infinite Choices. We aggregate e-commerce listings, independent sellers,
              and local retail stores into a single ecosystem to help you find the absolute best
              options instantly.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li>
                <Link href="/stores" className="text-on-surface-variant hover:text-secondary transition-colors">
                  Local Businesses
                </Link>
              </li>
              <li>
                <Link href="/wishlist" className="text-on-surface-variant hover:text-secondary transition-colors">
                  My Wishlist
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li>
                <Link href="/seller" className="text-on-surface-variant hover:text-secondary transition-colors">
                  Seller Portal
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-on-surface-variant hover:text-secondary transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/privacy" className="text-on-surface-variant hover:text-secondary transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-on-surface-variant hover:text-secondary transition-colors">
                  Terms &amp; Conditions
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-outline-variant pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-on-surface-variant">
          <p>© {CURRENT_YEAR} Andromeda Technologies. All rights reserved.</p>
